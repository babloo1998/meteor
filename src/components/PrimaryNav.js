    ...
    render(){
        ...
        <div className="collapse navbar-collapse navbardata" id="navbarTogglerDemo03">
            ...
            <li className="nav-item">
                <a className="nav-link" href="/">-5c New York<span className="sr-only">(current)</span></a>
            </li>
            <li className="nav-item">
                <a className="nav-link" href="/">Monday,March 6</a>
            </li>
            <li className="nav-item">
                <a className="nav-link" href="/" tabIndex="-1">Blog</a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
                <a className="nav-link" href="/" tabIndex="-1">Buy Now!</a>
            </li>
            </ul>
